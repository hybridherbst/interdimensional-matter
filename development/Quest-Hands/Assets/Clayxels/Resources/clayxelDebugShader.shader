...
Shader "Clayxel/ClayxelDebugShader" {
	Properties {
	}
	SubShader {
		...
		Pass {
	      ...
	      #pragma fragment frag
			...
			void geom(point VertexData inVertex[1], inout TriangleStream<GeomData> outGeo){
				...
				float3 vec1 = float3(unity_CameraToWorld[0][1], unity_CameraToWorld[1][1], unity_CameraToWorld[2][1]) * splatRadius;
				float3 vec2 = float3(unity_CameraToWorld[0][0], unity_CameraToWorld[1][0], unity_CameraToWorld[2][0]) * splatRadius;
